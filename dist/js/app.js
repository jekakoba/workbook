(() => {
    ...
    function initSliders() {
        if (document.querySelector(".workbook-content__slider")) {
            const sl = new swiper_core_Swiper(".workbook-content__slider", {
            ...
            if (window.innerWidth > 767.98 && sl.initialized) sl.slideTo(2, 0, false); else sl.on("init", (function() {
                if (window.innerWidth > 767.98) this.slideTo(2, 0, false);
            }));
            window.addEventListener("resize", (function() {
                if (window.innerWidth > 767.98) sl.slideTo(2, 0, false);
            }));
        }
        if (sliderCatalog) if (window.innerWidth <= 767.98 && sliderCatalog.dataset.mobile == "false") if (document.querySelector(".catalog__slider")) {
            mySwiper = new swiper_core_Swiper(".catalog__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
        ...
        if (document.querySelector(".product__slider-wrapper")) {
            let thumbsSwiper = new swiper_core_Swiper(".product-preview-images__slider", {
            ...
            new swiper_core_Swiper(".product-images__slider", {
                modules: [ Navigation, Thumb, Controller ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        if (document.querySelector(".item-catalog__slider")) {
            new swiper_core_Swiper(".item-catalog__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                observeSlideChildren: true,
        ...
        if (sliderCatalog) if (window.innerWidth > 767.98) {
            sliderCatalog.dataset.mobile = "false";
            if (sliderCatalog.classList.contains("swiper-initialized")) mySwiper.destroy();
        }
        if (document.querySelector(".other-presets__slider")) new swiper_core_Swiper(".other-presets__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            observeSlideChildren: true,
...
***************************************************************************** */
    ...
    da.init();
    let particles = document.querySelectorAll("canvas.particles"), radius = 1.95, number = 30;
    particles.forEach((node => {
        ...
        function createDots() {
            ...
            for (let i = 0; i < dots.num; i++) if (!dots.array[i]) {
    ...
    if (goTop) window.addEventListener("scroll", (function(e) {
